...
{
    0x6E8BFFFF, // Coefficient B0 will be multiplied with error input e(n-0)
    0xA6D5FFFF, // Coefficient B1 will be multiplied with error input e(n-1)
    0x9274FFFF, // Coefficient B2 will be multiplied with error input e(n-2)
    0x5A2AFFFF  // Coefficient B3 will be multiplied with error input e(n-3)
};
...
volatile int16_t VCOMP_pterm_factor = 0x70AB;     // Q15 fractional of the P-Term factor
